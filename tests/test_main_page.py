...
@allure.feature("Проверка заголовка главной страницы")
...
@allure.suite("Тесты главной страницы")
@allure.epic("Тестирование типового магазина")
@allure.feature("Проверка наличия элементов на главной странице")
...
@allure.suite("Тесты главной страницы")
@allure.epic("Тестирование типового магазина")
@allure.feature("Проверка добавления пользователя на главной странице")
...
@allure.suite("Тесты главной страницы")
@allure.epic("Тестирование типового магазина")
@allure.feature("Проверка изменения валюты на главной странице")
...
@allure.suite("Тесты главной страницы")
@allure.epic("Тестирование типового магазина")
@allure.feature("Проверка добавления/удаления товара на главной страницы")
